...
/**
 * Created by nicsi on 22-06-2017.
 */

public class informationbykhasara extends Activity  {
...
//Extract the data…
       ...
       // gkhata = bundle.getString("khata");
        ...
        try {
            new informationbykhasara.DownloadJSON().execute(new URL("http://10.130.19.227/WebApiDistrict/api/values/GetkhasaraInfoByKhasara?vill_link="+ vill_link +"&khasara="+ khasara +""));
            new informationbykhasara.DownloadJSON1().execute(new URL("http://10.130.19.227/WebApiDistrict/api/values/GetkhasaraInfoByKhasara?vill_link="+ vill_link +"&khasara="+ khasara +""));
            new informationbykhasara.DownloadJSON2().execute(new URL("http://10.130.19.227/WebApiDistrict/api/values/GetuserInfoByKhasara?vill_link="+ vill_link +"&khasara="+ khasara +""));
