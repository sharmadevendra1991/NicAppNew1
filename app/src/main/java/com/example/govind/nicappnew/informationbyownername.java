...
public class informationbyownername extends Activity {
...
//Extract the data…
        ...
        try {
            new informationbyownername.DownloadJSON().execute(new URL("http://10.130.19.227/WebApiDistrict/api/values/GetuserInfoByuser?vill_link="+ vill_link +"&user="+ user +""));
            new informationbyownername.DownloadJSON1().execute(new URL("http://10.130.19.227/WebApiDistrict/api/values/GetuserInfoByuser?vill_link="+ vill_link +"&user="+ user +""));
            new informationbyownername.DownloadJSON2().execute(new URL("http://10.130.19.227/WebApiDistrict/api/values/GetuserInfoByuser?vill_link="+ vill_link +"&user="+ user +""));
